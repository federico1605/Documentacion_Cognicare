...
![Arquetipo_Referencia](/Imagenes/ManualInstalacion/Arquetipo_Referencia.png)
...
1. Para verificar si tu sistema es de 32 o 64 bits:
   ...
   ![Explorador_Archivos](/Imagenes/ManualInstalacion/Explorador_Archivos.png)
   ![Propiedades_Explorador](/Imagenes/ManualInstalacion/Propiedades_Explorador.png)
   ![Final_Meto1](/Imagenes/ManualInstalacion/Final_Meto1.png)
   ...
   ![Meto2Confi](/Imagenes/ManualInstalacion/Meto2Confi.png)
   ![Meto2Final](/Imagenes/ManualInstalacion/Meto2Final.png)
   ...
   ![Meto3_Conso](/Imagenes/ManualInstalacion/Meto3_Conso.png)
   ![Meto3Final](/Imagenes/ManualInstalacion/Meto3Final.png)
...
![VariableInicio](/Imagenes/ManualInstalacion/VariableInicio.png)
...
![VariableInfo](/Imagenes/ManualInstalacion/VariableInfo.png)

- Donde debes de buscar una ruta parecida a esta:

![VariablesFinal](/Imagenes/ManualInstalacion/VariablesFinal.png)
...
![InstaladorNode](/Imagenes/ManualInstalacion/InstaladorNode.png)
...
![NodeInicio](/Imagenes/ManualInstalacion/NodeInicio.png)
...
![VariablesEntorno](/Imagenes/ManualInstalacion/VariablesEntorno.png)

Donde debe darle donde señala la flechala cual le abrirá:

![InfoVariables](/Imagenes/ManualInstalacion/InfoVariables.png)
...
![CrearVariable](/Imagenes/ManualInstalacion/CrearVariable.png)
...
![InstalarDocker](/Imagenes/ManualInstalacion/InstalarDocker.png)
...
![Windows Docker](/Imagenes/ManualInstalacion/Windows%20Docker.png)
...
- **"docker-compose: command not found"**: Este error aparece cuando el sistema no reconoce el comando docker-compose, lo que impide ejecutar archivos docker-compose.yml para levantar servicios. Puede deberse a una instalación incompleta, ausencia del binario, o configuración incorrecta del entorno.
    ...
    **En Windows:**
    ...
    ![Variables](/Imagenes/ManualInstalacion/Variables.png)

    Haga clic en 'Nuevo' y agregue la ruta al directorio donde se encuentra docker-compose.exe.

    ![VariablesDocker](/Imagenes/ManualInstalacion/VariablesDocker.png)
...
![PGAdminHome](/Imagenes/ManualInstalacion/PGAdminHome.png)
...
![IngresarPGAdmin](/Imagenes/ManualInstalacion/IngresarPGAdmin.png)
...
![RegistrarNombreServer](/Imagenes/ManualInstalacion/RegistrarNombreServer.png)
...
![RegistrarBD](/Imagenes/ManualInstalacion/RegistrarBD.png)
...
Lo cual veras esto:
![DBConectada](/Imagenes/ManualInstalacion/DBConectada.png)
...
![DockerContenedor](/Imagenes/ManualInstalacion/DockerContenedor.png)
...
![Swagger](/Imagenes/ManualInstalacion/Swagger.png)
...
![VisualDescargar](/Imagenes/ManualInstalacion/VisualDescargar.png)
...
![Visual](/Imagenes/ManualInstalacion/Visual.png)
...
![Proyecto](/Imagenes/ManualInstalacion/Proyecto.png)
